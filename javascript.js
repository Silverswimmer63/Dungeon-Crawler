...
function randomItem() {
  var index = Utils.randMath(0, allItem.length - 1);
  var Item = allItem[index];
  var retItem = new Item.type(Item.name, Item.type, Item.desc, Item.icon, Item.attackDam, Item.value, Item.range, Item.damageresist);
  return retItem;
}
