class Inventory extends Mob{
  ...
  The _inventory is an array as well. The inventory may or may not have items on it already.
  ...
  */
  ...
  @param Number{int} index value of the item that needs to be removed
  */
  drop(index){
