...
RESEARCH how to determine if something is an array in javascript    if isarray
...
*/
  ...
  function myFunction() {
  var stuff = ["value", "desc", "name", "icon"];
  var x = document.getElementById("");
  x.innerHTML = Array.isArray();
}
/*add(item)
put an itum in an inventory
@param item {obj}an object that inherts from class item
*/
  add(item){
   this._inventory.push(item);
  }
  /*drop(index)
  removes an item from an invintory
