...
const COMPLETE_MELEE_LIST = [
  ...
  },
  {
    ...
    damage:{min:20, max:50, type:"bleeding", dot:5},
    icon: "/"
  },
  {
    name: "Butcher Knife",
    ...
    damage: {min:10, max:15, type:"bleeding", dot:5},
    icon:"/"
  },
  {
    name: "Broad Sword",
    ...
    damage: {min:25, max:40, type:"bleeding", dot:5},
    icon:"/"
  },
  {
    name: "Stick",
  ...
  },
  {
    ...
    damage: {min:10, max:24, type:"bleeding", dot:5},
    icon:"/"
  }
]
...
const COMPLETE_RANGED_LIST = [
  ...
  },
  {
    ...
    icon: "L",
    range: 6,
    damage: {min:3, max:8, type:"fire", dot:3}
  },
  {
    name: "Greek Bow",
    type: Ranged,
    ...
    icon: "L",
    range: 5,
    damage: {min:6, max:8, type:"bleeding", dot:5}
  },
  {
    name: "Trained Falcon",
    type: Ranged,
    ...
    icon: "L",
    range: 5,
    damage: {min:5, max:6, type:"bleeding", dot:5}
  },
  {
    name: "Magnetic Rocks",
    type: Ranged,
  ...
  },
  {
    ...
    type: Ranged,
    value: 24,
    desc: "while normal throwing axes are a quarter size of a regular axe, these are the size of a full on battle axe",
    icon: "L",
    range: 2,
    damage: {min:16, max:24, type:"bleeding", dot:5}
  },
  {
    name: "Shootgun",
    type: Ranged,
    ...
    icon: "L",
    range: 4,
    damage: {min:20, max:26, type:"normal"},
  },
  {
    name: "Snake Lasso",
    type: Ranged,
    ...
    icon: "L",
    range: 5,
    damage: {min:24, max:26, type:"normal"},
  },
  {
    name: "Money Bag",
    type: Ranged,
    ...
    icon: "L",
    range: 4,
    damage: {min:26, max:28, type:"fire", dot:3}
  },
  {
    name: "Laser Pointer",
    type: Ranged,
    ...
    icon: "L",
    range: 10,
    damage: {min:28, max:34, type:"fire", dot:3}
  },
  {
    name: "Hacking Laptop",
    type: Ranged,
  ...
  },
  {
    ...
    icon: "L",
    range: 8,
    damage: {min:34, max:36, type:"normal"}
  },
  {
    ...
    icon: "L",
    range: 3,
    damage: {min:30, max:32, type:"heal"}
  },
  {
    name: "Replica Mouse",
    type: Ranged,
...
const COMPLETE_POTION_LIST = [
  ...
  },
  {
    ...
    icon:"P",
    damage:{min:5, max:20, type:"fire", dot:"3"},
  },
  /*
  {
    name:"Defence potion",
  ...
  */
  {
    ...
    icon:"P",
    freeze: {min:3, max:5, type:"ice", dot:"4"}
  },
  {
    name:"lightning",
    type:Potion,
