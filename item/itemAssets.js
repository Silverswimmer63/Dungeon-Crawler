...
const COMPLETE_MELEE_LIST = [
  ...
  },
  {
    ...
    damage:{min:20, max:50, type:"damage"},
    icon: "/"
  },
  {
    name: "Butcher Knife",
    ...
    damage: {min:10, max:15, type:"damage"},
    icon:"/"
  },
  {
    name: "Broad Sword",
    ...
    damage: {min:25, max:40, type:"damage"},
    icon:"/"
  },
  {
    name: "Stick",
  ...
  },
  {
    ...
    damage: {min:10, max:24, type:"damage"},
    icon:"/"
  }
]
...
const COMPLETE_RANGED_LIST = [
  ...
  },
  {
    ...
    icon: "C",
    range: 16,
    damage: {min:200, max:250, type:"electricity"}
  }
]
